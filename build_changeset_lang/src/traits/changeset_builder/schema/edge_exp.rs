    ...
    I: Default + Clone + PartialEq + Debug
{
    fn build_changeset_with_path(
        ...
        for key in edited_endpoints {
            ...
            if old_endpoint.quantity != new_endpoint.quantity || old_endpoint.attributes != new_endpoint.attributes {
        ...
        if &new_doc_comments != &self.comments.get_doc_comments() || new_version.attributes != self.attributes {
