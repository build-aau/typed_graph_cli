...
use crate::{GenResult, GeneratedCode, CodeGenerator, ToSnakeCase, targets, ToPythonType};

impl CodeGenerator<targets::Python> for NodeExp<String> {
...
/// Write ./node_type.rs
pub(super) fn write_node_type_py(
