...
fn snake_case_test() {
    assert_eq!(
        "HelloW;orld    How!Are  you".to_snake_case(),
        "hello_w;orld_how!_are_you"
    );
    ...
    assert_eq!(
        "Today.theDateIs:D.12/12/2023 12:00:00".to_snake_case(),
        "today.the_date_is:_d.12/12/2023_12:00:00"
    );
